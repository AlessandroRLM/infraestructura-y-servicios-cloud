/**
 * MarkPaidDialog component tests.
 *
 * Covers:
 *  - Confirm calls markEnrollmentPaid({id}) and shows success toast.
...
describe("MarkPaidDialog — confirm success", () => {
  it("calls markEnrollmentPaid({id}) and shows success toast", async () => {
    const user = userEvent.setup();
    const onOpenChange = vi.fn();
    const markEnrollmentPaid = vi.fn(async () => mockEnrollment);
...
describe("MarkPaidDialog — FailedPrecondition", () => {
  it("shows inline precondition message, no toast, dialog stays open", async () => {
    const user = userEvent.setup();
    const onOpenChange = vi.fn();
    const markEnrollmentPaid = vi.fn(async () => {
...
describe("MarkPaidDialog — transport error", () => {
...
describe("MarkPaidDialog — no auto-close on action click", () => {
