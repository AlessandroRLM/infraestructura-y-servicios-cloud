...
type Querier interface {
	...
	SoftDeleteCourse(ctx context.Context, arg SoftDeleteCourseParams) (int64, error)
	SoftDeleteProgram(ctx context.Context, arg SoftDeleteProgramParams) (int64, error)
