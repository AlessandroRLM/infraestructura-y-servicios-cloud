...
type AssignRoleRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// user_id is the UUID of the target user.
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// role is the role name to assign (admin | teacher | student).
...
type AssignRoleResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// user is the updated UserSummary for the target user after the assignment.
	User          *UserSummary `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RevokeRoleRequest struct {
	...
	// user_id is the UUID of the target user.
	UserId string `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// role is the role name to revoke (admin | teacher | student).
	Role          string `protobuf:"bytes,2,opt,name=role,proto3" json:"role,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RevokeRoleResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// user is the updated UserSummary for the target user after the revocation.
	User          *UserSummary `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
